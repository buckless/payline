...
<wsdl:definitions targetNamespace="http://impl.ws.payline.experian.com" xmlns:impl="http://impl.ws.payline.experian.com" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:wsdlsoap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tns1="http://obj.ws.payline.experian.com">
  <wsdl:types>
    <schema elementFormDefault="qualified" targetNamespace="http://impl.ws.payline.experian.com" xmlns="http://www.w3.org/2001/XMLSchema">
			...
			<element name="getAlertDetailsRequest">
				<complexType>
					<sequence>
						...
						<element maxOccurs="1" minOccurs="1" name="TransactionDate" nillable="true" type="xsd:string">
						</element>
					</sequence>
				</complexType>
			</element>
			...
			<element name="isRegisteredRequest">
				<complexType>
					<annotation>
						<documentation>
							This element is the request for the
			...
			<element name="isRegisteredResponse">
				<complexType>
					...
					<sequence>
						<element name="result" nillable="false" type="tns1:result"/>
						<element name="token" nillable="false" type="xsd:string"/>
						<element name="data" nillable="false" type="xsd:string"/>
					</sequence>
				</complexType>
			</element>
    ...
    <schema elementFormDefault="qualified" targetNamespace="http://obj.ws.payline.experian.com" xmlns="http://www.w3.org/2001/XMLSchema">
			...
			<complexType name="order">
				...
				<sequence>
					...
					<element minOccurs="0" name="deliveryCharge" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="discountAmount" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="otaPackageType" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="otaDestinationCountry" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="bookingReference" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="orderDetail" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="orderExtended" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="orderOTA" nillable="true" type="xsd:string"/>
				</sequence>
			</complexType>
			<complexType name="key">
				...
				<sequence>
                    ...
                    <element name="algo" nillable="true" type="xsd:string"/>
			...
			<complexType name="orderDetail">
				...
				<sequence>
					...
					<element minOccurs="0" name="seller" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="sellerType" nillable="true" type="xsd:string"/>
				</sequence>
			</complexType>
			...
			<complexType name="transaction">
				...
				<sequence>
					...
					<element minOccurs="0" name="scoring" nillable="true" type="tns1:scoring"/>
			...
			<complexType name="scoring">
				...
				<sequence>
					<element minOccurs="0" name="partnerId" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="orderId" nillable="true" type="xsd:string"/>
					...
					<element minOccurs="0" name="errorMessage" nillable="true" type="xsd:string"/>
				</sequence>
			</complexType>
			...
			<complexType name="payment">
				...
				<sequence>
					...
					<element minOccurs="0" name="method" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="softDescriptor" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="cardBrand" nillable="true" type="string"/>
					<element minOccurs="0" name="registrationToken" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="cumulatedAmount" nillable="true" type="xsd:string"/>
				</sequence>
			</complexType>
			...
			<complexType name="paymentData">
				...
				<sequence>
					<element minOccurs="0" name="transactionID" nillable="false" type="xsd:string"/>
					<element minOccurs="0" name="network" nillable="false" type="xsd:string"/>
					<element minOccurs="0" name="tokenData" nillable="false" type="xsd:string"/>
				</sequence>
			</complexType>
			...
			<complexType name="buyer">
				...
				<sequence>
					...
					<element name="isBot" nillable="true" type="xsd:string"/>
					<element name="isIncognito" nillable="true" type="xsd:string"/>
					<element name="isBehindProxy" nillable="true" type="xsd:string"/>
					<element name="isFromTor" nillable="true" type="xsd:string"/>
					<element name="isEmulator" nillable="true" type="xsd:string"/>
					<element name="isRooted" nillable="true" type="xsd:string"/>
					<element name="hasTimezoneMismatch" nillable="true" type="xsd:string"/>
					<element name="loyaltyMemberType" nillable="true" type="xsd:string"/>
					<element name="buyerExtended" nillable="true" type="xsd:string"/>
                    <element name="merchantAuthentication" nillable="true" type="tns1:merchantAuthentication"/>
				</sequence>
			</complexType>
			...
			<complexType name="address">
				...
				<sequence>
					...
					<element minOccurs="0" name="streetNumber" nillable="true" type="xsd:string"/>
					...
					<element minOccurs="0" name="addressCreateDate" nillable="true" type="xsd:string"/>
			...
			<complexType name="avs">
				...
				<sequence>
					...
					<element name="resultFromAcquirer" nillable="false" type="xsd:string"/>
				</sequence>
			</complexType>
			...
			<complexType name="recurring">
				...
				<sequence>
					...
					<element name="billingRank" nillable="true" type="xsd:string"/>
				</sequence>
			</complexType>
			...
			<complexType name="authentication3DSecure">
				...
				<sequence>
					...
					<element minOccurs="0" name="resultContainer" nillable="true" type="xsd:string"/>
					<element minOccurs="0" name="authenticationResult" nillable="true" type="xsd:string"/>
				</sequence>
			</complexType>
			...
			<complexType name="subMerchant">
				...
				<sequence>
					<element name="subMerchantId" nillable="false" type="xsd:string" wsdl:required="true"/>
					<element name="subMerchantName" nillable="true" type="xsd:string"/>
					<element minOccurs="1" name="subMerchantMCC" nillable="false" type="xsd:string"/>
					<element name="subMerchantSIRET" nillable="true" type="xsd:string"/>
					<element name="subMerchantTaxCode" nillable="true" type="xsd:string"/>
					<element name="subMerchantStreet" nillable="true" type="xsd:string"/>
					<element name="subMerchantCity" nillable="true" type="xsd:string"/>
					<element name="subMerchantZipCode" nillable="true" type="xsd:string"/>
					<element name="subMerchantCountry" nillable="true" type="xsd:string"/>
            ...
            <complexType name="threeDSInfo">
                ...
                <sequence>
                    <element name="challengeInd" nillable="true" type="xsd:string"/>
                    <element name="threeDSReqPriorAuthData" nillable="true" type="xsd:string"/>
                    <element name="threeDSReqPriorAuthMethod" nillable="true" type="xsd:string"/>
                    <element name="threeDSReqPriorAuthTimestamp" nillable="true" type="xsd:string"/>
                    <element name="browser" nillable="true" type="tns1:browser"/>
                    <element name="sdk" nillable="true" type="tns1:sdk"/>
                    <element name="threeDSMethodNotificationURL" nillable="true" type="xsd:string"/>
                    <element name="threeDSMethodResult" nillable="true" type="xsd:string"/>
                    <element name="challengeWindowSize" nillable="true" type="xsd:string"/>
                </sequence>
            </complexType>
            <complexType name="browser">
                ...
                <sequence>
                    <element name="acceptHeader" nillable="true" type="xsd:string"/>
                    <element name="javaEnabled" nillable="true" type="xsd:string"/>
                    <element name="javascriptEnabled" nillable="true" type="xsd:string"/>
                    <element name="language" nillable="true" type="xsd:string"/>
                    <element name="colorDepth" nillable="true" type="xsd:string"/>
                    <element name="screenHeight" nillable="true" type="xsd:string"/>
                    <element name="screenWidth" nillable="true" type="xsd:string"/>
                    <element name="timeZoneOffset" nillable="true" type="xsd:string"/>
                    <element name="userAgent" nillable="true" type="xsd:string"/>
                </sequence>
            </complexType>
            <complexType name="sdk">
                ...
                <sequence>
                    <element name="deviceRenderingOptionsIF" nillable="true" type="xsd:string"/>
  ...
  <wsdl:message name="doAuthorizationRedirectResponse">
    <wsdl:part name="parameters" element="impl:doAuthorizationRedirectResponse">
    </wsdl:part>
  </wsdl:message>
  ...
  <wsdl:message name="isRegisteredResponse">
    <wsdl:part name="parameters" element="impl:isRegisteredResponse">
    </wsdl:part>
  </wsdl:message>
  ...
  <wsdl:message name="doAuthorizationRedirectRequest">
    <wsdl:part name="parameters" element="impl:doAuthorizationRedirectRequest">
    </wsdl:part>
  </wsdl:message>
  ...
  <wsdl:message name="isRegisteredRequest">
    <wsdl:part name="parameters" element="impl:isRegisteredRequest">
    </wsdl:part>
  </wsdl:message>
  ...
  <wsdl:portType name="WebPaymentAPI">
    ...
    <wsdl:operation name="doAuthorizationRedirect">
      <wsdl:input name="doAuthorizationRedirectRequest" message="impl:doAuthorizationRedirectRequest">
    </wsdl:input>
      <wsdl:output name="doAuthorizationRedirectResponse" message="impl:doAuthorizationRedirectResponse">
    </wsdl:output>
    </wsdl:operation>
  </wsdl:portType>
  <wsdl:portType name="DirectPaymentAPI">
    ...
    <wsdl:operation name="isRegistered">
      <wsdl:input name="isRegisteredRequest" message="impl:isRegisteredRequest">
    </wsdl:input>
      <wsdl:output name="isRegisteredResponse" message="impl:isRegisteredResponse">
    </wsdl:output>
    </wsdl:operation>
  </wsdl:portType>
  ...
  <wsdl:binding name="DirectPaymentAPISoapBinding" type="impl:DirectPaymentAPI">
    ...
    <wsdl:operation name="isRegistered">
      <wsdlsoap:operation soapAction="isRegistered"/>
      <wsdl:input>
        <wsdlsoap:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="WebPaymentAPISoapBinding" type="impl:WebPaymentAPI">
    ...
    <wsdl:operation name="doAuthorizationRedirect">
      <wsdlsoap:operation soapAction="doAuthorizationRedirect"/>
      <wsdl:input>
        <wsdlsoap:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
